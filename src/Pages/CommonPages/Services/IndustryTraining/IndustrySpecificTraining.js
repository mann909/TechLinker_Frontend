...
import mainImage from '../../../../Assets/images/services/sectors/Job offers-amico.png';

const IndustrySpecificTraining = () => {
  const [activeCard, setActiveCard] = useState(null);

  const sectorData = {
    title: "Industry-Specific Training",
    description: "Our training programs are designed to equip candidates with the exact skills needed for your industry. We partner with industry experts to create training modules that prepare candidates to excel in their roles from day one.",
    mainImage: mainImage,
    sectors: [
      {
        id: 1,
        title: "Targeted Training Modules",
        description: "Our curriculum is crafted to address the specific skills and knowledge required in your industry",
        icon: Target  ,
      ...
      },
      {
        ...
        description: "We focus on hands-on training that translates directly into job performance.",
        icon: Hammer  ,
      ...
      {
        id: 3,
        title: "Certification and Evaluation",
        description: "Candidates receive certification upon successful completion of training, ensuring they meet industry standards.",
        icon: Award  ,
...
export default IndustrySpecificTraining;